namespace XMLDB3
{
    ...
    public class InquiryMyPageCommand : BasicCommand
    {
        ...
        public override bool DoProcess()
        {
            try
            {
                ItemMarketCommand command = new IMInquiryMyPageCommand(ConfigManager.ItemMarketServerNo, this.m_CharacterName, this.m_PageNo, this.m_PageItemCount, this.m_bSale, IMSortingType.ExpireDate, false);
        ...
        {
            WorkSession.WriteStatus("InquiryMyPageCommand.MakeMessage() : 함수에 진입하였습니다");
