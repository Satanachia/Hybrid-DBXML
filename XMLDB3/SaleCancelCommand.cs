namespace XMLDB3
{
    ...
    public class SaleCancelCommand : BasicCommand
    {
        ...
        public override bool DoProcess()
        {
            try
            {
                ItemMarketCommand command = new IMSaleCancelCommand(ConfigManager.ItemMarketServerNo, this.m_CharacterName, this.m_TradeID);
        ...
        {
            WorkSession.WriteStatus("SaleCancelCommand.MakeMessage() : 함수에 진입하였습니다");
