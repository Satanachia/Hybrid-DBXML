namespace XMLDB3
{
    ...
    public class GetItemCommitCommand : BasicCommand
    {
        ...
        public override bool DoProcess()
        {
            try
            {
                ItemMarketCommand command = new IMGetItemCommitCommand(ConfigManager.ItemMarketServerNo, this.m_CharacterName, this.m_TradeID);
        ...
        {
            WorkSession.WriteStatus("GetItemCommitCommand.MakeMessage() : 함수에 진입하였습니다");
