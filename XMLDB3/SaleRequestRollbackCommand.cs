namespace XMLDB3
{
    ...
    public class SaleRequestRollbackCommand : BasicCommand
    {
        ...
        public override bool DoProcess()
        {
            try
            {
                ItemMarketCommand command = new IMSaleRequestRollbackCommand(ConfigManager.ItemMarketServerNo, this.m_CharacterName, this.m_TradeID);
        ...
        {
            WorkSession.WriteStatus("SaleRequestRollbackCommand.MakeMessage() : 함수에 진입하였습니다");
