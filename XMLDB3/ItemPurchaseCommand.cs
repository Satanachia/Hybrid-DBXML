namespace XMLDB3
{
    ...
    public class ItemPurchaseCommand : BasicCommand
    {
        ...
        public override bool DoProcess()
        {
            try
            {
                ItemMarketCommand command = new IMPurchaseCommand(ConfigManager.ItemMarketServerNo, this.m_CharacterName, this.m_NexonID, this.m_TradeID);
        ...
        {
            WorkSession.WriteStatus("ItemPurchaseCommand.MakeMessage() : 함수에 진입하였습니다");
